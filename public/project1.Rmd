...
Above shows the mean distance I run on each day of the week. Most of my races occur on Saturday's, and I rarelt have Friday classes, so it makes sense that those two are the highest.
